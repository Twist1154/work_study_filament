                    ...
                    ->action(function ($record, array $data) {
                        ...
                        if ($allApproved) {
                            ...
                            Notification::make()
                                ...
                                ->body('Forwarded to HOD sign-off.')
                                ->send();
                        } else {
                ...
                Action::make('finalApprove')
                    ...
                    ->action(function ($record) {
                        ...
                        Notification::make()
                            ...
                            ->body('Active appointment has been registered.')
                            ->send();
                    })
                    ->color('success'),
            ]);
